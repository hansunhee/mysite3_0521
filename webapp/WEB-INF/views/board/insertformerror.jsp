...
<div id="container">
		...
		<div id="content">
			<div id="board">
				...
				<h3 id="errormsg">비밀번호가 틀렸습니다.</h3>
				<table width=500 id="insertForm">
				<tr>
					<th>제목</th><td colspan="3"><input type="text" name="title" required="required" id="title-box" value="${param.title }"></td>
				</tr>
				<tr>
					<th>작성자</th><td><input type="text" name="name" required="required" value="${sessionScope.authMember.name }"></td>
					<th>비밀번호</th><td><input type="password" name="password" required="required"></td>
				</tr>
					<tr>
					<td colspan=4><textarea name="content" cols=70 rows=5 required="required">${param.content }</textarea></td>
				</tr>
				</table>
				<div id="writeBtnDiv">
					<span>
